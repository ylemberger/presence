      ...
      >
        <div className="flex flex-col gap-5">
          <ol className="list-decimal space-y-1 pe-5 text-body-md text-on-surface-variant">
            ...
            <li>
              רשות: ת.ל. עברי, ת.ל. לועזי, טל, פל אב, פל אם, פל תלמידה, פסיכולוגיה, תוכנית חץ, כתובת ועוד. טלפונים: אפשר כמה מספרים בפסיק. חץ/פסיכולוגיה: ריק או ללא = לא, V = כן. ת.ל. לועזי מקבל כמה פורמטים.
            </li>
            <li>
