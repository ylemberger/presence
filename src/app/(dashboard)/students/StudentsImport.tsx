      ...
      >
        <div className="flex flex-col gap-5">
          <ol className="list-decimal space-y-1 pe-5 text-body-md text-on-surface-variant">
            ...
            <li>
              חובה: שם פרטי ומשפחה (או שם מלא), מ.ז., כיתה, מסלול, התמחות. עמודת תעודת זהות עדיף כטקסט.
            </li>
            <li>
              רשות: ת.ל. עברי, ת.ל. לועזי, טל, פל אב, פל אם, פל תלמידה, פסיכולוגיה, תוכנית חץ, כתובת ועוד. טלפונים: אפשר כמה מספרים בפסיק. חץ/פסיכולוגיה: ריק או ללא = לא, V = כן. ת.ל. לועזי מזוהה גם אם הפורמט לא אחיד.
            </li>
